  ...
  Future<void> scheduleDailyTransactionReminder() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
          ...
          channelDescription: 'Recordatorio diario para añadir transacciones',
    ...
    await _flutterLocalNotificationsPlugin.zonedSchedule(
      0, // notification id
      'Recordatorio de Transacciones', // title
      'Recuerda añadir tus transacciones del día de hoy', // body
      _nextInstanceOf8PM(),
